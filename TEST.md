...
**備考**: 2025-01-20 修正後テスト通過。keycode判定とlast_keyガード追加
...
**備考**: 2025-01-20 制限事項としてドキュメント化。--clean モードや非HTMLファイルでは動作しない可能性あり。GDScriptでは通常使用しない
...
**備考**: 2025-01-20 修正後テスト通過。行範囲コマンドをNeovimに転送
...
**備考**: 2025-01-20 修正後テスト通過。行範囲置換コマンドをNeovimに転送
